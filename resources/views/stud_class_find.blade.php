...
<div class="card card-custom">
	...
	<div class="card-header flex-wrap border-0 pt-6 pb-0">
		<div class="card-title">
			<h3 class="card-label">
				List of Class
				<span class="d-block text-muted pt-2 font-size-sm">Please take a look at the classes.</span>
			</h3>
		</div>
...
$(document).ready(function(){
  var datatable = $('#kt_datatable').KTDatatable({
            ...
            var index = KTUtil.getRandomInt(1, 4);
					...
					template: function() {
						return '\
                        <a href="{{route('stud_class_details1')}}" class="btn btn-light-success font-weight-bolder font-size-sm">View Details</a>\
	                    ';
					},
				}],
		});
