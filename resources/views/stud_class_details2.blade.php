            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="my-lg-0 my-1">
                        <a href="#" class="btn btn-sm btn-info font-weight-bolder text-uppercase">Purchased</a>
                    </div>
                </div>
                <!--end: Title-->
                ...
                <div class="d-flex align-items-center flex-wrap justify-content-between">
                    ...
                    <div class="d-flex flex-wrap align-items-center py-2">
                        <div class="d-flex align-items-center mr-10">
                            ...
                            <div class="">
                                <div class="font-weight-bold mb-2">Venue</div>
                                <span class="btn btn-sm btn-text btn-light-success text-uppercase font-weight-bold">Google Meet</span>
                            </div>
                        </div>
                    </div>
                </div>
