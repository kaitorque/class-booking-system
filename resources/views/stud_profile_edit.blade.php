...
<div class="card card-custom">
    ...
    <div class="card-body pt-4">
        ...
        <div class="py-9">
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <a href="#" class="text-muted text-hover-primary">kaitorque@gmail.com</a>
            </div>
            <div class="d-flex align-items-center justify-content-between mb-2">
                <span class="font-weight-bold mr-2">Phone:</span>
                <span class="text-muted">0149659658</span>
            </div>
            <div class="d-flex align-items-center justify-content-between">
                <span class="font-weight-bold mr-2">Location:</span>
                <span class="text-muted">Puchong</span>
            </div>
        </div>
        <!--end::Contact-->
        ...
        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
            <div class="navi-item mb-2">
                <a  href="#" class="navi-link py-4 active btn-personal">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="#000000" fill-rule="nonzero"/>
            ...
            <div class="navi-item mb-2">
                <a href="#" class="navi-link py-4 btn-account">
                    <span class="navi-icon mr-2">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" fill="#000000"/>
            ...
            <div class="navi-item mb-2">
                <a href="#" class="navi-link py-4 btn-password">
                    <span class="navi-icon mr-2">
...
<!--end::Profile Card-->
	...
	<div class="flex-row-fluid ml-lg-8">
		<!--begin::Card-->
		<div class="card card-custom card-stretch personal-information">
			<!--begin::Header-->
			...
			<form class="form">
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-6">
							<input class="form-control form-control-lg form-control-solid" type="text" value="Idham"/>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label text-right">Last Name</label>
						<div class="col-lg-9 col-xl-6">
							<input class="form-control form-control-lg form-control-solid" type="text" value="Idris"/>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label text-right">College Name</label>
						<div class="col-lg-9 col-xl-6">
							<input class="form-control form-control-lg form-control-solid" type="text" value="Quantum"/>
						</div>
					</div>
          <div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label text-right">Grades</label>
						<div class="col-lg-9 col-xl-6">
							<input class="form-control form-control-lg form-control-solid" type="text" value="Freelance Developer"/>
						</div>
					</div>
          <div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label text-right">Date</label>
            <div class="col-lg-9 col-xl-6">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-6">
							<div class="input-group input-group-lg input-group-solid">
								...
								<input type="text" class="form-control form-control-lg form-control-solid" value="0149659658" placeholder="Phone" />
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-6">
							<div class="input-group input-group-lg input-group-solid">
								...
								<input type="text" class="form-control form-control-lg form-control-solid" value="kaitorque@gmail.com" placeholder="Email" />
							</div>
						</div>
					</div>
				</div>
    ...
    <div class="card card-custom account-information d-none">
            <!--begin::Header-->
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
            ...
            <form class="form">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                          <input class="form-control form-control-lg form-control-solid" type="text" value="kaitorque" />
                        </div>
                    </div>
                    <!--begin::Form Group-->
                    <div class="form-group row">
    ...
    <div class="card card-custom change-password d-none">
        <!--begin::Header-->
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
...
<script>
  $(document).ready(function(){
    ...
    $('#kt_datepicker_6').datepicker({
     ...
     $(".btn-personal, .btn-account, .btn-password").on("click", function(){
       $(".btn-personal, .btn-account, .btn-password").removeClass("active");
       $(this).addClass('active');
       $(".personal-information, .account-information, .change-password").addClass("d-none");
       if($(this).hasClass('btn-personal'))
       {
         $(".personal-information").removeClass("d-none");
       }
       if($(this).hasClass('btn-account'))
       {
         $(".account-information").removeClass("d-none");
       }
       if($(this).hasClass('btn-password'))
       {
